...
//   var imageLink = books[i].imageLink;
...
let newDiv3 = document.createElement("div");
  newDiv3.setAttribute("id", "data");
let newP = document.createElement("p");
newDiv3.appendChild(newP)

// // let authorText = document.createTextNode("Author: ");

// // newP.appendChild(authorText);
 document.body.appendChild(newDiv3)

//document.getElementById("title").innerHTML = 5+6;
// for (var elem in books){
  
//   console.log(elem, books[elem]);
// }
for (let i = 0; i < books.length; i++) {
    document.write(" Author: " +  books[i].author  );
    
    document.write (" Title: " + books[i].title);

    document.write(" Price : $ " + books[i].price)
